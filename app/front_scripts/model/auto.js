...
require(['jquery', 'lodash', 'store', 'app', 'bootstrap', 'tipsy'], function ($, _, store, APP) {
  ...
  function createBuyModal() {
    ...
    var headHtml = '';
    var titleHtml = '您对模型<span class="mlr5">' + modelId + '</span> 设置了' + AUTO.issueVal + '期的自动投注 总投注金额为<span class="mlr5 fc-3">' + AUTO.totalVal + '</span>元（<span class="fc-84">系统会按期自动投注</span>）';
    var stopHtml = '';

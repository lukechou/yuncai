$(function () {
            ...
            for (var i = 0; i < detailData.length; i++) {
                ...
                switch (type) {
                    case 3:
                        ...
                        htmlOutput += '<tr><td>' + createIconTD(dataItem.gou, dataItem.lian, dataItem.xiao, dataItem.yan, dataItem.hasAutoBuy) + '</td>';
    ...
    function createIconTD(g, l, x, y, a) {
        var h = [];
        if (g) {
        ...
        if (a) {
            h.push('<i class="icon-font icon-f3" title="您设置自动投注已投注该模型">自</i>');
        }
        return h.join('');
    }

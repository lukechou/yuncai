...
require(['jquery', 'app', 'webuploader', 'bootstrap', 'cropper'], function($, APP, WebUploader) {
  ...
  $('#j-toggle-head').on('click', function(event) {
    ...
    $('#j-info-text1,#j-info-text2').hide();
  });

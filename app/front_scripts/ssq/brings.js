...
$(function() {
  ...
  $('.btn-add').on('click', function(event) {
    ...
    var html = '',
      rNums = [],
      bNums = [],
      tips = ['请先选择号码', '至少选择' + SEEDS.ssq.redTotal + '个前区号码和' + SEEDS.ssq.blueTotal + '个后区号码', '您好，单个投注的金额应小于2万元，请返回重新选择'];
  ...
  $('#sd_sub').on('click', function(event) {
    ...
    var l = '';
    var html = '';
    var tips = ['<h5>您好，请按照正确格式填写，例：</h5><p>格式1：01,02,03,04,05,06+10</p><p>格式2：01,02,03,04,05,06+10', '请输入投注号码'];

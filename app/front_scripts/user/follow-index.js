          ...
          for (var i = 1; i <= detailData.length; i++, j++) {
            ...
            if(dataItem.followed){
              if(dataItem.follow_type==1){
                htmlOutput += '<tr><td>' + j + '</td><td class="td2 j-user-name" csm-where="' + dataItem.csm_where + '" follow-id="' + dataItem.id + '" uid="' + dataItem.uid + '" loty-name="' + dataItem.loty_name + '"><a target="_blank" href="/user/profile/index/' + dataItem.uid + '">' + dataItem.username + '</a></td><td class="td3">' + dataItem.loty_cnname + '</td><td class="td5"><span class="td5span">' + dataItem.bonus_30day + '</span>元</td><td class="td6">' + dataItem.bonus_total + '元</td><td class="td7">' + dataItem.follower_num + '</td><td class="td8">' + dataItem.follow_value + '元</td><td class="td9">' + dataItem.follow_times + '次</td>' + '<td class="td10"><button class="btn-gray" disabled>已定制</button><a class="btn-sear j-high-level" target="_blank" href="/user/profile/index/' + 　dataItem.uid + '">修改</a></td></tr>';
              }else if(dataItem.follow_type==2){
                htmlOutput += '<tr><td>' + j + '</td><td class="td2 j-user-name" csm-where="' + dataItem.csm_where + '" follow-id="' + dataItem.id + '" uid="' + dataItem.uid + '" loty-name="' + dataItem.loty_name + '"><a target="_blank" href="/user/profile/index/' + dataItem.uid + '">' + dataItem.username + '</a></td><td class="td3">' + dataItem.loty_cnname + '</td><td class="td5"><span class="td5span">' + dataItem.bonus_30day + '</span>元</td><td class="td6">' + dataItem.bonus_total + '元</td><td class="td7">' + dataItem.follower_num + '</td><td class="td8">' + dataItem.follow_value + '%</td><td class="td9">' + dataItem.follow_times + '次</td>' + '<td class="td10"><button class="btn-gray" disabled>已定制</button><a class="btn-sear j-high-level" target="_blank" href="/user/profile/index/' + 　dataItem.uid + '">修改</a></td></tr>';
              }
            }else{

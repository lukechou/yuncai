...
require(['jquery', 'lodash', 'store', 'app', 'index', 'owl', 'bootstrap'], function ($, _, store, APP, index) {
  ...
  function setLuckyBetting() {
    ...
    var fortune = {
      ...
      xzYCArr: {
        y0: ["财运开低走高，平缓逐步上扬。", "辛勤累积期待后期丰盛的回收。", "事业运很旺，有机会获得领导权。", "财运让人羡慕，积极运作得财顺。", "整体运势良好，有利于大胆投资。", "满脑子投资经，适合简单的投资。", "财运顺畅，彩票一族小有收获。", "有计划的消费可以达到收支平衡。", "财运一般，会因犹豫而错失好时机。", "自控能力增强，投资有出色表现。", "运势平缓，意外的财富需多打理。", "聚财需另辟蹊径，控财能力才会好。", "凭勇气挑战，能积累战胜它的经验。"],
        ...
        y9: ["运势一般，收入靠广开财路，积小成多。", "财务支出意外花销不断，总体盈余不多。", "对苦干失去信心，期待巧妙省力的赚钱方式。", "运势回升，有机会参与新的获利模式。", "处在平衡的状态，银行存款数字看起来很美。", "工作中保持明智能带来颇有成效的结果。", "财运较好，金钱方面存在不错的收益。", "整体运势颇佳，现金流十分理想。", "精力达到顶峰状态，事业压力与释放感并存。"],
    ...
    var luckyNum = 11;
    var xzYc = fortune.xzYCArr['y' + num][num];
    ...
    //   'num': num,
    //   'name': fortuneArr[num].name,
    //   'date': fortuneArr[num].date,
    // }));
  ...
  function initXzObj() {
    ...
    for (var i = fortune.length - 1; i >= 0; i--) {
      index.xz.push(fortune[i]);
      // 产生当天星座对应幸运号码
      // 产生当天星座对应运程
    };
